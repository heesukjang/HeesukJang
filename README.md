...
<div>
 ...
 <ul>
  ...
  <li><strong>Models Utilized</strong>: CNNs (Baseline), <strong>Vision Transformer (Top Performer)</strong>, XGBoost, and Transfer Learning models like VGG16, ResNet50, EfficientNet.</li>
...
<ul>
 ...
 <li><strong>Models Utilized</strong>: Logistic Regression (Baseline), <strong>XGBoost (Top Performer)</strong>, Decision Tree, Gradient Boosting, Random Forest, Mulitilayer Perception Classifier, and CNNs.</li>
